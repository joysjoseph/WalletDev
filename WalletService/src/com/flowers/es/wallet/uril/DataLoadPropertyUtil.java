	...
	public static String getFuctionalParameterValue(String strParameterName, String strDefaultValue) {
		...
		try {
			...
			if (!isConfigInfoAlreadyLoaded()){		
				...
				//String xmlConfigFileName_windows = "D:\\home\\site\\config\\wallet_service_config.xml";
				String xmlConfigFileName_windows = "D:\\home\\site\\wwwroot\\config\\wallet_service_config.xml";
